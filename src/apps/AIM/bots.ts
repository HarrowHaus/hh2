...
export const BOT_BUDDIES: BotBuddy[] = [
  {
    ...
    tone: 'dry, opinionated, warm underneath',
  ...
  },
  {
    ...
    tone: 'gruff, nostalgic, all-lowercase',
  ...
  },
  {
    ...
    tone: 'oblique, conspiratorial, poetic',
    randomFree: true,
  ...
  },
  {
    ...
    tone: 'grandiose, reverent, sermon-like',
  ...
  },
  {
    ...
    tone: 'chipper, robotic',
    model: 'eliza', // stays on ELIZA — a clunky 2003 pattern bot is period-accurate
