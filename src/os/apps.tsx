...
export const APPS: Record<AppId, AppEntry> = {
  ...
  quake3: { Icon: Quake3Icon, Component: named(() => import('../apps/Quake3/Quake3'), 'Quake3') },
  ...
  podcast: { Icon: PodcastIcon, Component: named(() => import('../apps/Podcast/Podcast'), 'Podcast') },
  aichat: { Icon: AiChatIcon, Component: named(() => import('../apps/AIChat/AIChat'), 'AIChat') },
  myspace: { Icon: MySpaceIcon, Component: named(() => import('../apps/MySpace/MySpace'), 'MySpace') },
}
