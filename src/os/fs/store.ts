...
export const useFS = create<FSState>()(
  persist(
    ...
    {
      name: 'hmd.fs',
      // v27: + Desktop/read me.txt (curated loadout). v26: + Desktop/MySpace launcher. v25: + Program Files/iPodder (podcatcher). v24: + My Documents/Blog Posts (.whtml writable-HTML posts). v23: + Emulators/EmulatorJS
